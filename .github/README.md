...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JlroUcuEx02v2t2PiZpVGAfczACf5ON+B02aTOiFH+fyd5c5Muf5oFecFpHLqjeP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.913.0/index.min.mjs": "sha384-JlroUcuEx02v2t2PiZpVGAfczACf5ON+B02aTOiFH+fyd5c5Muf5oFecFpHLqjeP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.913.0/LICENSE
```

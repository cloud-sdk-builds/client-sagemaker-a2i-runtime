...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V22e6EjtBmF+EceIudb3S0gmuldrIdczdV7E5oTaMQ99mZEwrazJs5EcZ8SB1fVB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.327.0/index.min.mjs": "sha384-V22e6EjtBmF+EceIudb3S0gmuldrIdczdV7E5oTaMQ99mZEwrazJs5EcZ8SB1fVB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.327.0/LICENSE
```

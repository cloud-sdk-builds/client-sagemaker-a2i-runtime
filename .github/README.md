...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YjcKDKtoD6+QRBGi0E+o1aF+eLNYKkEdM0LcE3mL0+/BbkLusVek+mhcu1jijbLJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.470.0/index.min.mjs": "sha384-YjcKDKtoD6+QRBGi0E+o1aF+eLNYKkEdM0LcE3mL0+/BbkLusVek+mhcu1jijbLJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.470.0/LICENSE
```

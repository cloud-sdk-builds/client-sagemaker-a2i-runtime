...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vTIjDj507h03GuIAkBawqGByH43LxJ9lGKMI16cy1s31V2FWuTwpVM/BRQCTzQ5Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.616.0/index.min.mjs": "sha384-vTIjDj507h03GuIAkBawqGByH43LxJ9lGKMI16cy1s31V2FWuTwpVM/BRQCTzQ5Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.616.0/LICENSE
```

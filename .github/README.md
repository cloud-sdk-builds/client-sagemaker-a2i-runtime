...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-onEXdyXJVIb6YiI6dv/ABCrza5S1QCcZmkyCE3L21BUeFfVUSFk0LBrjo303iZIk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.637.0/index.min.mjs": "sha384-onEXdyXJVIb6YiI6dv/ABCrza5S1QCcZmkyCE3L21BUeFfVUSFk0LBrjo303iZIk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.637.0/LICENSE
```

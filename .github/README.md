...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aybTxqgZUiQAHkfwbWjEXwqxU25F1mLgrAtOHA1Q+cTjZXNxS8WV4tMq7sXoV+hr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.662.0/index.min.mjs": "sha384-aybTxqgZUiQAHkfwbWjEXwqxU25F1mLgrAtOHA1Q+cTjZXNxS8WV4tMq7sXoV+hr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.662.0/LICENSE
```

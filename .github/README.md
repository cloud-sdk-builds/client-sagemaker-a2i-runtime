...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oVn4c+3zDS+LxuxkGWsAxY5zxxjuMGvZYSOAXEVdyu+r+Pg5yzhC5P3osQGHtF2X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.171.0/index.min.mjs": "sha384-oVn4c+3zDS+LxuxkGWsAxY5zxxjuMGvZYSOAXEVdyu+r+Pg5yzhC5P3osQGHtF2X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.171.0/LICENSE
```

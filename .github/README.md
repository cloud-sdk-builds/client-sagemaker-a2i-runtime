...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GJ7alpaqcDgwhj4CMO0xbVzKsvVpEM0OL4eKX4NaGtJXedSVxSqQeY89n0sowHt5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.170.0/index.min.mjs": "sha384-GJ7alpaqcDgwhj4CMO0xbVzKsvVpEM0OL4eKX4NaGtJXedSVxSqQeY89n0sowHt5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.170.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dOxUkEbBA7FCDr+q3MO5VgZ3UiVEN/PIK8Qcb7oXJOSm/1q0PnBhIK9TqlOzw+Me
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.433.0/index.min.mjs": "sha384-dOxUkEbBA7FCDr+q3MO5VgZ3UiVEN/PIK8Qcb7oXJOSm/1q0PnBhIK9TqlOzw+Me"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.433.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zBeg1n+cv7qt88xB882oXk2HD3Nz1XyrseF3y7ixyFkg1s94eE+rHsyN67ZOCOM+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.0/index.min.mjs": "sha384-zBeg1n+cv7qt88xB882oXk2HD3Nz1XyrseF3y7ixyFkg1s94eE+rHsyN67ZOCOM+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.6.0/LICENSE
```

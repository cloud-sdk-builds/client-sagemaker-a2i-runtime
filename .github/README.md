...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JtZ3OjCRQ/diZiANXXsaaAA2A5bhKDwZxvoQ2tlA70Itbitlgz0xUUKKKA8CD5nt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.245.0/index.min.mjs": "sha384-JtZ3OjCRQ/diZiANXXsaaAA2A5bhKDwZxvoQ2tlA70Itbitlgz0xUUKKKA8CD5nt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.245.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YIsU00Vy1s3u7/y6l9+3Tom7hp/wYm/M0PJXyGWQocJ2zXEpvwLDxY84NumpvnUC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.465.0/index.min.mjs": "sha384-YIsU00Vy1s3u7/y6l9+3Tom7hp/wYm/M0PJXyGWQocJ2zXEpvwLDxY84NumpvnUC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.465.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Wn3HdbpopBHJ17WeF8xd0PDIMtRhhgdSvg9fLDdp8AtOCoHKjL48EdEwKeLZGdWR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.592.0/index.min.mjs": "sha384-Wn3HdbpopBHJ17WeF8xd0PDIMtRhhgdSvg9fLDdp8AtOCoHKjL48EdEwKeLZGdWR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.592.0/LICENSE
```

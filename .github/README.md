...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1GKazKVNS3HFB0liti7SPNkGd5CcqMbNrscLq4py+wkaOiiRtV04yX02CSPp1OW0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.281.0/index.min.mjs": "sha384-1GKazKVNS3HFB0liti7SPNkGd5CcqMbNrscLq4py+wkaOiiRtV04yX02CSPp1OW0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.281.0/LICENSE
```

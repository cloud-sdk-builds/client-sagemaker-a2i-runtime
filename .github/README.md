...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yaq1qf/z5uWZgRokBQQoBAiTsLzbb+cORe40IC9l8tToTkBQcAFTd8JSFb2iJrci
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.713.0/index.min.mjs": "sha384-yaq1qf/z5uWZgRokBQQoBAiTsLzbb+cORe40IC9l8tToTkBQcAFTd8JSFb2iJrci"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.713.0/LICENSE
```

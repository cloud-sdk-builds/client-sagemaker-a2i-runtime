...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a9aWsZBKlC/EG10508X/yHbr22Id4TL6+nAtI6BOMeNR46v4f+9ycUh+pC9Umhnl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.25.0/index.min.mjs": "sha384-a9aWsZBKlC/EG10508X/yHbr22Id4TL6+nAtI6BOMeNR46v4f+9ycUh+pC9Umhnl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x1NfUjur7BnCx6caJnYTpJoXedZwzDNjT5k6/EdNk6edmpxdyV67AQERP9w/LQjD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.906.0/index.min.mjs": "sha384-x1NfUjur7BnCx6caJnYTpJoXedZwzDNjT5k6/EdNk6edmpxdyV67AQERP9w/LQjD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.906.0/LICENSE
```

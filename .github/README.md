...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zIRhjJ43KJYU27YlEO+qut/1n3vMUcBmIvMD+soqvTQPqdRY5aXhLXvO7/NDR2LQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.17.0/index.min.mjs": "sha384-zIRhjJ43KJYU27YlEO+qut/1n3vMUcBmIvMD+soqvTQPqdRY5aXhLXvO7/NDR2LQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.17.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JxpB+BDdwvOE+uSawsMIc7VI+Mu/zfq6BgrZXDq5XNMcL34OOSo5hM0s0rOz4KW/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.435.0/index.min.mjs": "sha384-JxpB+BDdwvOE+uSawsMIc7VI+Mu/zfq6BgrZXDq5XNMcL34OOSo5hM0s0rOz4KW/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.435.0/LICENSE
```

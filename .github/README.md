...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-efhW5Gas6jtUNIXFosWNdC4Wg+iVXMQLVlokfPmO+rFs1/aiGqtkP0H40UT+OZjW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.19.0/index.min.mjs": "sha384-efhW5Gas6jtUNIXFosWNdC4Wg+iVXMQLVlokfPmO+rFs1/aiGqtkP0H40UT+OZjW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.19.0/LICENSE
```

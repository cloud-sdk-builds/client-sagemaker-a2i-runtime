...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-32P8flgpRF0dteY+M/CpMxmLVhwZBY68z3HKMBHHWy2QrT0NJYnOnQ/eHYb4n3C8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.341.0/index.min.mjs": "sha384-32P8flgpRF0dteY+M/CpMxmLVhwZBY68z3HKMBHHWy2QrT0NJYnOnQ/eHYb4n3C8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.341.0/LICENSE
```

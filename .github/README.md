...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EV4qSouA5fup9fxuQsNGoG/eE7YhTVwUuGPprw3sg/Pq5OWKi7dwG7VnuUdAQ3DI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.192.0/index.min.mjs": "sha384-EV4qSouA5fup9fxuQsNGoG/eE7YhTVwUuGPprw3sg/Pq5OWKi7dwG7VnuUdAQ3DI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.192.0/LICENSE
```

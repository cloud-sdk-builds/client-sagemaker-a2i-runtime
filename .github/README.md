...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-rImb1JhZzTNR4NQPbCFdE00UQ+MypIJIKre6jbahz5ItqJEjsOAVHAB8u+67RNyS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.1/index.min.mjs": "sha384-rImb1JhZzTNR4NQPbCFdE00UQ+MypIJIKre6jbahz5ItqJEjsOAVHAB8u+67RNyS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.726.1/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p3Zisj0XsMiusScgoTOPBtQS95AUGaM03mhEXwMVn8PPnpJJrZEQT/HWTdq5ooYN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1035.0/index.min.mjs": "sha384-p3Zisj0XsMiusScgoTOPBtQS95AUGaM03mhEXwMVn8PPnpJJrZEQT/HWTdq5ooYN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.1035.0/LICENSE
```

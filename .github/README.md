...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-gC8c/+nm2DLT7rPoV6V4Qjq1OpnGU4MIImZog3co8TTEUWMhqNVsd/cHvKy+cy+1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.4.1/index.min.mjs": "sha384-gC8c/+nm2DLT7rPoV6V4Qjq1OpnGU4MIImZog3co8TTEUWMhqNVsd/cHvKy+cy+1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.4.1/LICENSE
```

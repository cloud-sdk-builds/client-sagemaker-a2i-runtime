...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-976rW6b1RnODCYgeAC5kBIxS+XpSM0flIPRZq4cUzdiGiW14sYw/E6ipHFKTmTGF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.360.0/index.min.mjs": "sha384-976rW6b1RnODCYgeAC5kBIxS+XpSM0flIPRZq4cUzdiGiW14sYw/E6ipHFKTmTGF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.360.0/LICENSE
```

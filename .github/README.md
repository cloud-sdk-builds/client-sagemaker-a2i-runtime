...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cTssvI34oXbFb4DQqEou7nIxQ56ewgBgu59+C4aaTTRnFWo/Ln3njWhqhLvBWanJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.258.0/index.min.mjs": "sha384-cTssvI34oXbFb4DQqEou7nIxQ56ewgBgu59+C4aaTTRnFWo/Ln3njWhqhLvBWanJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.258.0/LICENSE
```

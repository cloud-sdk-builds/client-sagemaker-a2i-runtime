...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MP+P/ok5HMUXzm3D8k5XvGn5kuTLKT0pD8gDMwstVjxJ3ZOZuQAcxkVwJdNWBQxA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.58.0/index.min.mjs": "sha384-MP+P/ok5HMUXzm3D8k5XvGn5kuTLKT0pD8gDMwstVjxJ3ZOZuQAcxkVwJdNWBQxA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.58.0/LICENSE
```

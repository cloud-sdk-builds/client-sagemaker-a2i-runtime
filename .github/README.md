...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-00sIa/2wIlXzEt8m1PxfaacBkfmNhMP0hUNK8VoViN2x3YwIsGL/iIeq29TrG/lX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.911.0/index.min.mjs": "sha384-00sIa/2wIlXzEt8m1PxfaacBkfmNhMP0hUNK8VoViN2x3YwIsGL/iIeq29TrG/lX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.911.0/LICENSE
```

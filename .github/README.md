...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-90ANnI+p95tRpOPqecu8Z6uInFfoSNmWVgXhn18C9rkPiVqwXpue5+VOLMX+aFij
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.272.0/index.min.mjs": "sha384-90ANnI+p95tRpOPqecu8Z6uInFfoSNmWVgXhn18C9rkPiVqwXpue5+VOLMX+aFij"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.272.0/LICENSE
```

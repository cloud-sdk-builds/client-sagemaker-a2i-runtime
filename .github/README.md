...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bJa+qO/HStr5Od2l/8ZRY+NAOyDtYNijKdlzvgi+QuF9935WFok6lkUGgalFl4bv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.631.0/index.min.mjs": "sha384-bJa+qO/HStr5Od2l/8ZRY+NAOyDtYNijKdlzvgi+QuF9935WFok6lkUGgalFl4bv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.631.0/LICENSE
```

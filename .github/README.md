...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZASs4caW8oYPofDFafz/fXdn4IEw/64HqtM40ZIqHj9SZX+4OXvIxVzWODJ8Iebd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.568.0/index.min.mjs": "sha384-ZASs4caW8oYPofDFafz/fXdn4IEw/64HqtM40ZIqHj9SZX+4OXvIxVzWODJ8Iebd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.568.0/LICENSE
```

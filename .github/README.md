...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HHVY0bRKUD6FPvXaDxhdNB6JBXBWKuIv9cUIgKEn9KoACzFOvdN9ZbyND8eypQ1X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.388.0/index.min.mjs": "sha384-HHVY0bRKUD6FPvXaDxhdNB6JBXBWKuIv9cUIgKEn9KoACzFOvdN9ZbyND8eypQ1X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.388.0/LICENSE
```

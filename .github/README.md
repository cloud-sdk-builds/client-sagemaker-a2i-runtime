...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3/hDDajucgSzL8swhg31QcQBkgwKQMRT0CVZ0xGlfqytOlIRkWz/7+Mf1fLoPa0R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.391.0/index.min.mjs": "sha384-3/hDDajucgSzL8swhg31QcQBkgwKQMRT0CVZ0xGlfqytOlIRkWz/7+Mf1fLoPa0R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.391.0/LICENSE
```

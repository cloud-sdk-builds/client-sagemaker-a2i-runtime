...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PeRpJQLTKBP7hA+Gofa9E9ERtFectxiXzPeU8U/bMoCCazKpbYGpvR5fofdl8lAF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.382.0/index.min.mjs": "sha384-PeRpJQLTKBP7hA+Gofa9E9ERtFectxiXzPeU8U/bMoCCazKpbYGpvR5fofdl8lAF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.382.0/LICENSE
```

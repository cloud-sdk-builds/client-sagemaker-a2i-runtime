...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FaBAShCiYL3/ZCqXRUL2MdL7Q5busTRaH2b6HPlsTP+Mocb9WOrUP41uGEjy1BlF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.6.1/index.min.mjs": "sha384-FaBAShCiYL3/ZCqXRUL2MdL7Q5busTRaH2b6HPlsTP+Mocb9WOrUP41uGEjy1BlF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.6.1/LICENSE
```

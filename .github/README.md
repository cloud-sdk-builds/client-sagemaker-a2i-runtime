...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sTq+B4ts71+3sbZNeafcNZ09fCqnCliwLJjyeFitSkBqSCEmCxU3U9V/D+yuW4rL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.948.0/index.min.mjs": "sha384-sTq+B4ts71+3sbZNeafcNZ09fCqnCliwLJjyeFitSkBqSCEmCxU3U9V/D+yuW4rL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.948.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OvPUxa2APgPdVOFoz/nqwWKVE6u7WVxBiU8qAoLoOoByuos0hlJyY5BWvo1ra3vS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.998.0/index.min.mjs": "sha384-OvPUxa2APgPdVOFoz/nqwWKVE6u7WVxBiU8qAoLoOoByuos0hlJyY5BWvo1ra3vS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.998.0/LICENSE
```

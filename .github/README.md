...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g2tPYlHxS8f0tF4V5Z1CimmbsJrmYUAFiauRQXiAIYf3EPDPHoeOr1dBMaFEar02
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.726.0/index.min.mjs": "sha384-g2tPYlHxS8f0tF4V5Z1CimmbsJrmYUAFiauRQXiAIYf3EPDPHoeOr1dBMaFEar02"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.726.0/LICENSE
```

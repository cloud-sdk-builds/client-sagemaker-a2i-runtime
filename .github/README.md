...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WJua17orVkibe9blTCKNc2vK9iPF+IOAobjC0wOd5Nl+ariA61QsApXSK4wVYBQs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.876.0/index.min.mjs": "sha384-WJua17orVkibe9blTCKNc2vK9iPF+IOAobjC0wOd5Nl+ariA61QsApXSK4wVYBQs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.876.0/LICENSE
```

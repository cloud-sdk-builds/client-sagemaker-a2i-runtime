...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WV1BPAvmfLdnhxqRpTz43UiEp8iRhhQzONb8rri0IO9urklL+8nezAJGia62CqYB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.907.0/index.min.mjs": "sha384-WV1BPAvmfLdnhxqRpTz43UiEp8iRhhQzONb8rri0IO9urklL+8nezAJGia62CqYB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sJVZe+qG4e83rDKvBaBBIFviE5TF9kWdxxd/ezVtDmBuvDPmmpxS6jvr3lyRCPlC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.254.0/index.min.mjs": "sha384-sJVZe+qG4e83rDKvBaBBIFviE5TF9kWdxxd/ezVtDmBuvDPmmpxS6jvr3lyRCPlC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.254.0/LICENSE
```

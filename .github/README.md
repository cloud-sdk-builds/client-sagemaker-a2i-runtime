...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SX/m2p/bZvPNDp2EJEX4UMzdgZIdowre67d9eMQnK/FyJ1iHGIKyyCniXF6fL/3y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.777.0/index.min.mjs": "sha384-SX/m2p/bZvPNDp2EJEX4UMzdgZIdowre67d9eMQnK/FyJ1iHGIKyyCniXF6fL/3y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.777.0/LICENSE
```

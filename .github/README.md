...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-POAEIz4sNNnBpRP9lu3tihll6zkRvyD7pmN6sPf0pAIM4aw3+PNybvOTdBK+BCAE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.154.0/index.min.mjs": "sha384-POAEIz4sNNnBpRP9lu3tihll6zkRvyD7pmN6sPf0pAIM4aw3+PNybvOTdBK+BCAE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.154.0/LICENSE
```

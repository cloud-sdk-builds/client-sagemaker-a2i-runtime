...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UNc6t0NVMI9/Exbh461qDwktOQdZwAJTunmqNU5/eWV9P7uP7+5DOuaIATdZBbyo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.241.0/index.min.mjs": "sha384-UNc6t0NVMI9/Exbh461qDwktOQdZwAJTunmqNU5/eWV9P7uP7+5DOuaIATdZBbyo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.241.0/LICENSE
```

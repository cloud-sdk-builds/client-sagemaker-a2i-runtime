...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.915.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.915.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FtZRr7+cAPxobqfVvCIqzrsa4E1MPhyPE4S99LbIB6l26xbWHoAjxcNaSio3M7FQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.915.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.915.0/index.min.mjs": "sha384-FtZRr7+cAPxobqfVvCIqzrsa4E1MPhyPE4S99LbIB6l26xbWHoAjxcNaSio3M7FQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.915.0/LICENSE
```

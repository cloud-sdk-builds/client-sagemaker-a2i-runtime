...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mmQt38tZvOoB2MorPr1F/G3IfuZUiCNor9GrwbuEem703S7vPGgOvizC5visGkJo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.932.0/index.min.mjs": "sha384-mmQt38tZvOoB2MorPr1F/G3IfuZUiCNor9GrwbuEem703S7vPGgOvizC5visGkJo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.932.0/LICENSE
```

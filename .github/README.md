...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pq6rmQ0jtinQsedIu+8xCs5zZJfZTOfJrgK8orYxAMXjrvPgflEbt8+lIwE5P3DB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.200.0/index.min.mjs": "sha384-pq6rmQ0jtinQsedIu+8xCs5zZJfZTOfJrgK8orYxAMXjrvPgflEbt8+lIwE5P3DB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.200.0/LICENSE
```

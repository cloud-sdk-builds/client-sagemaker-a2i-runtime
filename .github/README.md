...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-brAh7jwbLtT60QB3ER4Yykj6Uz50OH7PXypyqVqyLRQHTnAF3xvvXyRTE2EqDhEa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.953.0/index.min.mjs": "sha384-brAh7jwbLtT60QB3ER4Yykj6Uz50OH7PXypyqVqyLRQHTnAF3xvvXyRTE2EqDhEa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.953.0/LICENSE
```

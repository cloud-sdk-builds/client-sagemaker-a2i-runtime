...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KBHE9dO/d0PGPEG+TTJUBRhv7eQauNcKbLgPNC7Kks1cjySJR9Gn9X/Sv4ka+Y/S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.326.0/index.min.mjs": "sha384-KBHE9dO/d0PGPEG+TTJUBRhv7eQauNcKbLgPNC7Kks1cjySJR9Gn9X/Sv4ka+Y/S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.326.0/LICENSE
```

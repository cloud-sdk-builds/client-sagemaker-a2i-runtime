...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UQuif6tL3d/A05fMSzZ5ABsELLuNT7EmG2uOBkjm07yeARCXWXEzkL1C1dKbsRPg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.168.0/index.min.mjs": "sha384-UQuif6tL3d/A05fMSzZ5ABsELLuNT7EmG2uOBkjm07yeARCXWXEzkL1C1dKbsRPg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.168.0/LICENSE
```

...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f12qO0GI+cIla63+AP8NMoc8QR7Y4UfFeiVZiReTqlgTV7lvVhUi+p4HPGqNA+wZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.504.0/index.min.mjs": "sha384-f12qO0GI+cIla63+AP8NMoc8QR7Y4UfFeiVZiReTqlgTV7lvVhUi+p4HPGqNA+wZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.504.0/LICENSE
```

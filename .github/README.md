...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SSjiscKZQR+esYz5V0qS/ZBeZUMvB7Jea3bOgxeiYg4k+5Qmnhdzz0U+YcNYeP/s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.279.0/index.min.mjs": "sha384-SSjiscKZQR+esYz5V0qS/ZBeZUMvB7Jea3bOgxeiYg4k+5Qmnhdzz0U+YcNYeP/s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.279.0/LICENSE
```

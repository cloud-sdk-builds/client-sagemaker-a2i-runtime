...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ZYi+Mm6kkiydjAArXvNgresDlNRsDNncyTQFs5/9YL2Qeq05bwu3TjcoJ9ZFmKT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.354.0/index.min.mjs": "sha384-6ZYi+Mm6kkiydjAArXvNgresDlNRsDNncyTQFs5/9YL2Qeq05bwu3TjcoJ9ZFmKT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.354.0/LICENSE
```

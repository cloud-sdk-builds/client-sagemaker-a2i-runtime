...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9mQRRGusXlI1wE3TIefz1Gn3JY0OjcLUMamvQR18MmvZ1VyWHJRlS5dsY8bNZ3+X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.985.0/index.min.mjs": "sha384-9mQRRGusXlI1wE3TIefz1Gn3JY0OjcLUMamvQR18MmvZ1VyWHJRlS5dsY8bNZ3+X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.985.0/LICENSE
```

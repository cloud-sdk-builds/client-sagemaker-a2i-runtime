...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uoLceb0PEeBkCoSjm8icR+EkS5k55T0aVUhtRIzAZzlT8rOZ7s1zBzZvVeazoO1k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.572.0/index.min.mjs": "sha384-uoLceb0PEeBkCoSjm8icR+EkS5k55T0aVUhtRIzAZzlT8rOZ7s1zBzZvVeazoO1k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.572.0/LICENSE
```

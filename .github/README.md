...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0BtOXEyZdFp8Wy9LAJ7TzLwxbGIpxSC1VsjOwVLy0kqPR27KfxgrNGx+Y7OM3xdu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.197.0/index.min.mjs": "sha384-0BtOXEyZdFp8Wy9LAJ7TzLwxbGIpxSC1VsjOwVLy0kqPR27KfxgrNGx+Y7OM3xdu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.197.0/LICENSE
```

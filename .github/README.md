...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NJdFC5SVEBYva41sAvUVYPKuI9vjpfyoFniSd95QDE9IXUNdy3KYTnxd/gfRE6LA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.956.0/index.min.mjs": "sha384-NJdFC5SVEBYva41sAvUVYPKuI9vjpfyoFniSd95QDE9IXUNdy3KYTnxd/gfRE6LA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.956.0/LICENSE
```

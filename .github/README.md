...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-/CE+dRK3DGuHYjaObBRUToj6e+UQhdROIerjs9gEUQgrM0IS4sWQEWDnaKr7Z+KO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.379.1/index.min.mjs": "sha384-/CE+dRK3DGuHYjaObBRUToj6e+UQhdROIerjs9gEUQgrM0IS4sWQEWDnaKr7Z+KO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.379.1/LICENSE
```

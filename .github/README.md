...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d0c2WKzb7+yaS+ziUzfkGYr2ZMTll7pT6r1DCX0qROfbGiDY7UC0EozBzXso+4bH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.110.0/index.min.mjs": "sha384-d0c2WKzb7+yaS+ziUzfkGYr2ZMTll7pT6r1DCX0qROfbGiDY7UC0EozBzXso+4bH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.110.0/LICENSE
```

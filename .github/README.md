...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lB67K2w2+mHvxFx0ZS9sQz6sDagGULtjb3D34I++dxbYNplHcvfiVk2amO3blhy1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.808.0/index.min.mjs": "sha384-lB67K2w2+mHvxFx0ZS9sQz6sDagGULtjb3D34I++dxbYNplHcvfiVk2amO3blhy1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.808.0/LICENSE
```

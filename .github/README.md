...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.1044.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1044.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TEsPVDJh2bWEN0e8Ch/y4WomOl1gI+UZEcO8EZOoCXcAIO9Cwxy+wuxYFr8vjStq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1044.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.1044.0/index.min.mjs": "sha384-TEsPVDJh2bWEN0e8Ch/y4WomOl1gI+UZEcO8EZOoCXcAIO9Cwxy+wuxYFr8vjStq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.1044.0/LICENSE
```

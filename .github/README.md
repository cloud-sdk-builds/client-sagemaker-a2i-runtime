...
[`@aws-sdk/client-sagemaker-a2i-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-a2i-runtime/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7t7sr5wzcNRpZpV+0Qe78nsQHdL+4StsmF6Sw/cmkrJk7L8awOLW9WsJfUsBGmT/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-a2i-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-a2i-runtime@3.312.0/index.min.mjs": "sha384-7t7sr5wzcNRpZpV+0Qe78nsQHdL+4StsmF6Sw/cmkrJk7L8awOLW9WsJfUsBGmT/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-a2i-runtime/blob/refs/tags/3.312.0/LICENSE
```
